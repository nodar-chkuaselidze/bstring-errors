...
exports.locateErrors = function locateErrors(address, defaultPrefix) {
  ...
  throw new Error('Invalid address, Could not locate errors.');
};

/*
 * Expose cashaddr functions
 */

exports.ChecksumError = ChecksumError;
exports.serialize = cashaddr.serialize;
exports.deserialize = deserialize;
exports.encode = cashaddr.encode;
exports.decode = cashaddr.decode;
exports.test = cashaddr.test;
